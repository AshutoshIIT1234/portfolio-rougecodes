...
// Add parallax effect to sections with videos
...
gsap.utils.toArray('video:not(.hero-video):not(.section-video), img:not(.logo img)').forEach(media => {
    gsap.from(media, {
        scrollTrigger: {
            trigger: media,
            start: 'top 90%',
...
console.log('🚀 RougeCodes - Enhanced animations loaded successfully!');
